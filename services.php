                    ...
                    <div class="col-lg-6 col-md-12 ps-5">
                        <div class="service-content">
                            ...
                            <ul class="service-features">
                                <li><i class="fas fa-check"></i> High-pressure valve solutions</li>
                                <li><i class="fas fa-check"></i> Custom valve design</li>
                                <li><i class="fas fa-check"></i> Quality certification</li>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 order-lg-1 pe-5">
                        <div class="service-content">
                            ...
                            <ul class="service-features">
                                <li><i class="fas fa-check"></i> Custom engineering design</li>
